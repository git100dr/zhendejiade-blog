---
title: 'python脚本生成MDX文件头'
date: '2025-08-15'
tags: ['python', 'mdx', 'blog']
lastmod: '2025-08-15'
draft: false
summary:
---

## python代码生成MDX文件头（frontmatter）：

---

**实现步骤：**

1. 需要提取按照python-slugify库；
2. 根目录新建一个Python文件，如 create_blog_post.py，代码如下；
3. 终端运行脚本：python create_blog_post.py。
